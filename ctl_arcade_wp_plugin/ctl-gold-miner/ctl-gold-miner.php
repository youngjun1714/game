<?php
    /*
    Plugin Name: CTL Arcade - Gold Miner
    Plugin URI: http://www.codethislab.com/
    Description: Gold Miner for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeGoldMiner {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-gold-miner";
        private $_szPluginName              = "Gold Miner";
        private $_szAspectRatio             = "25:12";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "arcade, classic game, digger, game, gold miner, html5, mobile, puzzle, puzzle game, arcade game";
    ...
    $g_oCTLArcadeGoldMiner =  new CTLArcadeGoldMiner();
